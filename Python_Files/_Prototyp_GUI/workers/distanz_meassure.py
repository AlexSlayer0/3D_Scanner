...
def live_mode(calib):
    ...
    with dai.Device(pipeline) as device:
        ...
        while True:
            ...
            cv2.putText(disp_color, text_minz, (x1, y1 - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
            cv2.putText(disp_color, text_hoehe, (x1, y1 - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)

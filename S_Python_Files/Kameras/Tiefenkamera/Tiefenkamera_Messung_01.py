...
def pixel_to_mm(pixel_x, pixel_y, bild_breite, bild_hoehe):
...
def find_object(tiefenbild, boden_tiefe):
...
with pipeline:
    ...
    while pipeline.isRunning():
        ...
        objekt = find_object(frameDepth, boden_tiefe)
        ...
        if objekt:
            ...
            # Maße berechnen
            breite_mm, laenge_mm = pixel_to_mm(x+w, y+h, display.shape[1], display.shape[0])
            start_x_mm, start_y_mm = pixel_to_mm(x, y, display.shape[1], display.shape[0])

...
# ==============================
# Vorhandene Kalibrierfaktoren & Zero-Offsets
# ==============================
faktoren = [-0.004423, -0.00425, -0.004543]  # deine Kalibrierfaktoren
zero_offsets = [0.0] * len(adc_channels)    # werden per Tara gesetzt
...
# ==============================
gewicht_alt_list = [0.0] * len(adc_channels)  # für Glättung
